...
describe('ng-add', () => {
    ...
    describe('with one project', () => {
        ...
        it('should add npm script "extract-i18n" to package.json', () => {
            const tree = runSchematic({}, appTree);
            const packageJson = common_testing_spec_1.readPackageJson(tree);
            const extractScript = packageJson.scripts[common_1.extractScriptName];
            expect(extractScript).toBeTruthy();
            expect(extractScript).toBe('ng xi18n --i18n-format xlf --output-path i18n --i18n-locale en && xliffmerge --profile xliffmerge.json');
        });
        it('should add npm script "extract-i18n" to package.json including language list as command line parameter', () => {
            ...
            expect(extractScript).toBeTruthy();
            expect(extractScript).toBe('ng xi18n --i18n-format xlf --output-path i18n --i18n-locale en && xliffmerge --profile xliffmerge.json en de');
        });
